...
func main() {
	...
	err = g.extract("LICENSE", "mimalloc_LICENSE.txt")
	if err != nil {
		fmt.Printf("\n")
		panic(err.Error())
	}
	...
	err = g.extract("readme.md", "mimalloc_README.md")
	if err != nil {
		fmt.Printf("\n")
		panic(err.Error())
	}
	...
	fmt.Printf("Creating amalgamation... ")
	err = g.createAmalgamation("mimalloc_amalgamation.h")
	if err != nil {
		fmt.Printf("\n")
		panic(err.Error())
	}
...
func (g *generator) extract(srcFile, targetFile string) error {
	contents, err := g.readZipFile(srcFile)
	if err == nil {
		var f *os.File
...
func (g *generator) createAmalgamation(targetFile string) error {
	var f *os.File

	g.amalgamationLines = append(g.amalgamationLines, "// Code generated by go-mimalloc/gen - DO NOT EDIT.")
	g.amalgamationLines = append(g.amalgamationLines, "")
